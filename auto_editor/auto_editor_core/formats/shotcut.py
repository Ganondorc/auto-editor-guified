...
from auto_editor.auto_editor_core.timeline import v3

if TYPE_CHECKING:
    from collections.abc import Sequence

    from auto_editor.auto_editor_core.ffwrapper import FFmpeg
    from auto_editor.auto_editor_core.timeline import TlAudio, TlVideo
    from auto_editor.auto_editor_core.utils import Log
