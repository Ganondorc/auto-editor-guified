...
def parse_with_palet(
    ...
    from auto_editor.auto_editor_core.lang import Lexer, Parser, interpret
    from auto_editor.auto_editor_core.lib.data_structs import print_str
    from auto_editor.auto_editor_core.lib import MyError
